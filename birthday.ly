...
| %{ bar 6: %}
 ...
 \note-mod "3" e''4^.  \note-mod "1" c''4^. | %{ bar 7: %}
 \note-mod "7" b'4
(  \note-mod "6" a'4 ) \fermata \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "4" f''8^.[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
%% === BEGIN 5-LINE STAFF ===
 ...
 \tempo 4=90 \transpose c c { \key c \major  \time 3/4 r2 g'8 g'8 | %{ bar 2: %} a'4 g'4 c''4 | %{ bar 3: %} b'2 g'8 g'8 | %{ bar 4: %} a'4 g'4 d''4 | %{ bar 5: %} c''2 g'8 g'8 | %{ bar 6: %} g''4 e''4 c''4 | %{ bar 7: %} b'4 ( a'4 ) \fermata f''8 f''8 | %{ bar 8: %} e''4 c''4 d''4 | %{ bar 9: %} c''2. } } }
% === END 5-LINE STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Y" { \tempo 4=90 \transpose c c { \key c \major  \time 3/4 r2 g'8 g'8 | %{ bar 2: %} a'4 g'4 c''4 | %{ bar 3: %} b'2 g'8 g'8 | %{ bar 4: %} a'4 g'4 d''4 | %{ bar 5: %} c''2 g'8 g'8 | %{ bar 6: %} g''4 e''4 c''4 | %{ bar 7: %} b'4 ( a'4 ) \fermata f''8 f''8 | %{ bar 8: %} e''4 c''4 d''4 | %{ bar 9: %} c''2. } } }
% === END MIDI STAFF ===
